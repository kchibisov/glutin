...
impl Display {
    pub(crate) fn find_configs(
        ...
        if self.inner.client_extensions.contains("GLX_ARB_fbconfig_float") {
        ...
        // TODO, this requires extension for GLX 1.3 Add samples. Otherwise it's supported
        // above GLX 1.4.
...
impl GlConfig for Config {
    ...
    fn native_visual(&self) -> u32 {
        self.raw_attribute(glx::VISUAL_ID as c_int) as u32
    }
